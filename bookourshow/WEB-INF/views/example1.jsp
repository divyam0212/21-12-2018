...
<body id="myPage" data-spy="scroll" data-target=".navbar"
	...
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse" id="myNavbar">
			<ul class="nav navbar-nav navbar-right">
				...
				<li><a href="#registerModal" data-toggle="modal" data-target="#registerModal"><span class="glyphicon glyphicon-user"></span>SIGN UP</a></li>
  ...
  <div class="modal fade" id="registerModal" role="dialog">
	...
	<div id="book" class="container">
		<div class="container">
			<form name="moviedetail" action="LocationController" method="post">
				<div class="form-group">
					<label for="sel1">Select Location:</label> <select
						class="form-control" id="sel1" name="address">
				...
				<div class="form-group">
					<input class="form-control input-md " style="color: white; background-color: #C3222A" value="EXPLORE" name="explore" id="inputlg" type="submit">
				</div>
			</form>
		</div>
		<!-- 
	...
	<div id="movie" class="bg-1">
		<div class="container">
			...
			<form name="moviedetail" action="DispVenue" method="post">
				...
				<div class="form-group">
					<br>
					<label for="inputmd">DATE:</label> <input
						class="form-control input-lg" id="inputlg" type="date"
						name="bookDate">
				</div>
				<label>Select Language</label> <select class="form-control input-lg"
					name="languageId">
				...
				<div class="form-group">
					<br> <input class="form-control input-md "
						style="color: white; background-color: #C3222A" value="BUTTON"
						name="EXPLORE" id="inputlg" type="button">
				</div>
			</form>
		</div>
	</div>
