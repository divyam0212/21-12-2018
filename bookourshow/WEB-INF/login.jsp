...
<div id="container">
       ...
       <div id="content">
                     ...
                     <div id="main">
                           ...
                           <form name="loginhr" method="post" action="LoginController">
                           ...
                           <table align="center">
                                  ...
                                  <tr>
                                         ...
                                         <td colspan="2"><input data-placement="right" class="textbox iconuser" type="text" name="username" placeholder="Enter UserName or Email"></td>

                                  </tr>

                                  <tr>

                                         <td colspan="2"><input data-placement="right" class="textbox iconpass" type="password" name="password" placeholder="Enter Password"></td>

                                  </tr>

                                  <tr>

                                         <td colspan="2"><input data-placement="right" class="btn2" type="submit" name="submit" value="LOGIN">
